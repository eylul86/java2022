...
public class C01_IfElseStatemenet {
    public static void main(String[] args) {
        /*Soru 5) Kullanicidan gun ismini yazmasini isteyin.
        Girilen isim gecerli bir gun ise gun isminin
        1.,2. ve 3.harflerini ilk harf buyuk diger ikisi
         kucuk olarak yazdirin, gun ismi gecerli
        ...
        if (gun.equals("pazartesi")) {
            ...
            System.out.println("lütfen gecerli bir gün ismi yazınız");
