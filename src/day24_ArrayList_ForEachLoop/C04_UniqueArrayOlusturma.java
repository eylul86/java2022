...
public class C04_UniqueArrayOlusturma {
    public static void main(String[] args) {
      //  Soru 2) Verilen bir array’deki tekrar eden
        //  elementleri tek bır defa barındıran
    ...
    public static int[] uniqueArrayOlustur(int[] arr) {
        ...
        // benzersiz listenin size bilgisini kullanarak bir array olusturduk      //burdan sonrasını anlamadım
