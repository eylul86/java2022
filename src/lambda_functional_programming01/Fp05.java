...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println(ortalamaPuanVerilendenBuyukMu(coursesList, 75)); //true
        System.out.println(kelimeKursAdlariIcindeVarMi(coursesList, "Turkish")); //True
...
// büyük olup olmadığını kontrol etmek için bir method oluşturun.
    ...
    public static boolean ortalamaPuanVerilendenBuyukMu(List<Courses> list, int x) {
