...
public class Fp03 {
    ...
    public static void main(String[] args) {
        ...
        sonKarakter(liste);
        System.out.println();
        uzunlukVeIlkHarf(liste);
        System.out.println();
        bestenBuyukleriSil(liste);
        System.out.println("***");
        baslangiciAYadaSonuNOlaniSil(liste);
        System.out.println(onikidenUzun(liste));
        System.out.println(xIleBaslamasin(liste));
...
//4) Elemanları son karakterlerine göre sıralayıp tekrarsız yazdıran bir method oluşturun.
    ...
    public static void sonKarakter(List<String> list) {
...
public static void uzunlukVeIlkHarf (List<String> list) {

        list.stream().sorted(Comparator.comparing(String::length).thenComparing(Utils::ilkKarakterAl)).forEach(Utils::ayniSatirdaBosluklaYazdir);
...
//7) ‘A’, ‘a’ ile başlayan yada ‘N’, ‘n’ ile biten elemanları silen bir method oluşturun.
 ...
 //   public static void baslangiciAYadaSonuOlaniSil(List<String> list) {
...
//9) Tüm elemanların uzunluklarının 12'den az olup olmadığını kontrol eden bir method oluşturun.
    ...
    public static boolean onikidenUzun(List<String > list) {
...
//10) Hiçbir elemanın 'X' ile başlamadığını kontrol eden bir method oluşturun.
    ...
    public static boolean xIleBaslamasin (List<String > list) {
